...
class AdaptiveNavigationDestination {
  ...
  /// iOS-only: name of an image in the iOS app bundle (UIImage(named: ...)).
  ///
  /// When provided on iOS 26+ native tab bar, this takes precedence over [icon]
  /// and will be used to create a UITabBarItem with a UIImage.
  ///
  /// Note: This is intended for native UITabBar rendering. For non-native bars,
  /// use [icon]/[selectedIcon] as usual.
  final String? iosAssetIcon;

  /// iOS-only: optional selected-state image name in the iOS app bundle.
  ///
  /// If null, [iosAssetIcon] will be reused for selected state.
  final String? iosAssetSelectedIcon;
