      ...
      'tabs': tabs
          .map(
            (tab) => {
              ...
              'assetIcon': tab.assetIcon,
              'assetSelectedIcon': tab.assetSelectedIcon,
...
class NativeTabConfig {
  ...
  ///
  /// When provided, this will be used instead of [sfSymbol].
  final String? assetIcon;

  /// iOS-only: selected-state image name in the iOS app bundle.
  ///
  /// If null, [assetIcon] will be reused for selected state.
